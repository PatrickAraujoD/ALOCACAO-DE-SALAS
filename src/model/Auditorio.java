...
public class Auditorio extends Espaco implements Serializable{
    /* Classe responsavel por armazenar os auditorios que vem do documento, essa classe herda a Classe Espaco*/
    private static final long serialVersionUID = 1L;
    public Auditorio(int capacidade, String nome, String localizacao) {
